...
do
	...
	curl -sH 'Accept: application/rdf+xml' -L https://w3id.org/solar/o/$MODULE/ > /home/solarchem/data/ontologies/$MODULE.owl
	...
	curl -X 'POST' \
	  ...
	  -H 'Authorization: GDB eyJ1c2VybmFtZSI6InNvbGFyY2hlbSIsImF1dGhlbnRpY2F0ZWRBdCI6MTcyNzg3MzIyMjM1MX0=.9FucE8drUU8SW2Aq0m4kbMDew61+4O3emKION6WbrPE=' \
	  --data-binary '@/home/solarchem/data/ontologies/'$MODULE'.owl'
done
